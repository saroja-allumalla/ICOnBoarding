...
export class ThemeComponent implements OnInit {
    ...
    constructor(private _script: ScriptLoaderService, private _router: Router) {
        this.isStartPage = this._router.url === "/" ? true : false;        
        console.log('saroja start page')
        console.log(this.isStartPage)
    ...
    ngOnInit() {
        ...
        this._router.events.subscribe((route) => {
            if(route instanceof NavigationEnd){
                if(route.url === "/driver/start" || route.url === "/index" || route.url === "/driver/recruitor" ) this.isStartPage = true; else this.isStartPage = false;
            }
